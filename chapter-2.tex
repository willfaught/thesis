...
Empty lists are written \expnils{\varty} in \thehaskellml and are written \expnild in \thescheme. List constructions are written \expcons{\varexp}{\varexp} in \thehaskellmlscheme. Empty lists and list constructions \havetype{\tylist{\vartyh}} in \thehaskellml. \Thescheme has the predicates \expplist{\varexp} and \exppnull{\varexp}. 
