...
Natural number values, addition and subtraction operations and their operands, and guards of natural number conditions have type $N$.  Function values, left expressions of function applications, operands of fixed-point operations, have type $T_{1}\rightarrow T_{2}$.  Type abstraction values and expressions of type applications have type $\forall X.T$.  List constructions, tails of list constructions, empty lists, tail operations, operands of head and tail operations, and guards of list conditions have type $[T]$.
