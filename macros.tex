...
\newcommand{\profv}{forced value\xspace}
\newcommand{\profvs}{\profv{}s\xspace}
...
\newcommand{\pscasesone}[3]{If #1 is a \profv then #2 determines the reduction of #3.}
\newcommand{\pscasestwo}[4]{If #1 is a \profv then #2 and #3 determine the reduction of #4.}
...
\newcommand{\psvalifone}[2]{If #1 is a \profv then #2}
\newcommand{\psvaliftwo}[3]{If #1 and #2 are \profvs then #3}
