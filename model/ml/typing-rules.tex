...
\quad
\frac{\Gamma\vdash_{M}e_{M}:T}{\Gamma\vdash_{M}\mathtt{force}\;e_{M}:T}
\]
\[
\frac{\Gamma\vdash_{M}T\quad\Gamma\vdash_{H}T\quad\Gamma\vdash_{H}e_{H}:T}{\Gamma\vdash_{M}{^{T}M}H^{T}\;e_{H}:T}
\quad
