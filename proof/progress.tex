...
\end{subcase}
\begin{subcase}
$e_{H}^{1}=\,^{(\forall X.T_{2})[T_{i}/T_{i}^{a}]}HS\;v_{S}$

$(^{(\forall X.T_{2})[T_{i}/T_{i}^{a}]}HS\;v_{S})\;\lbrace T_{1}\rbrace\rightarrow\,^{T_{2}[T_{1}^{a}/X]}HS\;v_{S}$.
\end{subcase}
\begin{case}
