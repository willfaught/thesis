...
\newcommand{\psval}[3]{\judeh{}{#1}{#2} by lemmas \ref{leminv} and \ref{lemuni} and #3 by lemma \ref{lemcan}.}
\newcommand{\psvaleq}[3]{\psval{#1}{#2}{#1 $=$ #3}}
\newcommand{\psvalin}[3]{\psval{#1}{#2}{$#1 \in \lbrace #3 \rbrace$}}
\newcommand{\psvalif}[2]{If #1 is a \profv then #2}
\newcommand{\psvalifeq}[3]{\psvalif{#1}{\psvaleq{#1}{#2}{#3}}}
\newcommand{\psvalifin}[3]{\psvalif{#1}{\psvalin{#1}{#2}{#3}}}
