...
\newcommand{\psvalset}[3]{If #1 is a \profv then \judeh{}{#1}{#2} by lemmas \ref{leminv} and \ref{lemuni} and $#1 \in \lbrace #3 \rbrace$ by lemma \ref{lemcan}.\xspace}
\newcommand{\psvalcase}[3]{\judeh{}{#1}{#2} by lemmas \ref{leminv} and \ref{lemuni} and #1 $=$ #3 by lemma \ref{lemcan}.\xspace}
\newcommand{\pssub}[4]{If #1 \red #2 then #3 \red #4.\xspace}
\newcommand{\pssubif}[5]{If #1 \red #2 and #3 is a \profv then #4 \red #5.\xspace}
\newcommand{\psred}[2]{\redrule{#1}{#2}.\xspace}
\newcommand{\psrednote}[3]{\redrule{#1}{#2} $(#3)$.\xspace}
\newcommand{\pserr}[2]{If #1 \red \emph{\experr{\varstr}} then #2 \red \emph{\experr{\varstr}}.\xspace}
\newcommand{\pserrif}[3]{If #1 \red \emph{\experr{\varstr}} and #2 is a \profv then #3 \red \emph{\experr{\varstr}}.\xspace}
\newcommand{\pscases}[4]{If #1 is a \profv then #2 and #3 determine the reduction of #4.\xspace}
...
{\first{\varexpm}}
{\tylump}
{\expmh{\tylump}{\second{\vartyh}}{\varexph}, \expms{\cslump}{\varexps}}


\first{\varexpm} = \expmh{\tylump}{\second{\vartyh}}{\varexph}
hm t t (ms k v) is a forced value
